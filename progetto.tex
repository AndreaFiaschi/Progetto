...
\end{center} 
%\vskip 0.5cm
For my PhD project I would focus both on hardware and data analysis. Exploiting the knowledge acquired during my thesis work I would to keep on studying Serial Powering for CMS Inner Tracker (IT), in addition to this I aim to run data analysis for process with production of HH states using 2017-2018 data set and to run Monte Carlo simulations with the goal to investigate Higgs boson pair production in the
upgrade scenario to verify the sensitivity of this channel and the potential benefits from CMS upgrades. %for the future data take at High Luminosity LHC (HL-LHC). 
...
Its crucial that the Phase-2 detector can cope with the challenging environment of HL-LHC as pileup mitigation, b-tagging, tau-tagging, photon identification efficiencies, and mass resolutions are instrumental to perform these measurements.
