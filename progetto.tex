...
\end{center} 
%\vskip 0.5cm
For my PhD project I would focuse both on hardware and data analysis. Exploiting the knowledge aquired during my thesis work I would to keep on studing serial powering for CMS Inner Tracker (IT), in addition to this I aim to run data analisys for process with production of HH states for  2017-2018 data set and to run Monte Carlo simulations with the goal of understand the feasibility of many studies and analysis for the future data take at High Luminosity LHC (HL-LHC). 
